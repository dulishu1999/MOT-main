...
from ui.ui_files.SavingUI import Ui_saving_ui
...
class SavingWidget(QtWidgets.QWidget):
    def __init__(self, parent: QtWidgets.QWidget = None) -> None:
        ...
        self.widget.output_folder_selector.setIcon(QtGui.QIcon(os.path.join("ui","icons", "more-horizontal.svg")))

        # setup resume_folder
        self.widget.resume_input.setMode("folder")
        self.widget.resume_input.highlight = True
        self.widget.resume_selector.setIcon(QtGui.QIcon(os.path.join("ui","icons", "more-horizontal.svg")))
