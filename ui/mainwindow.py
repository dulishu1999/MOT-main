...
"}")
        ...
        #配置一个控件
        self.src_cam_button = QPushButton(self.MenuBox)#在MenuBox中添加一个button按键
...
"background-image: url(:/all/img/graph.png);\n"
"background-repeat: no-repeat;\n"
"background-position: left center;\n"
"border: none;\n"
"border-left: 23px solid transparent;\n"
...
"}")
        ...
        self.src_lock_button.setObjectName(u"src_graph_button")
...
"background-image: url(:/all/img/lock.png);\n"
"background-repeat: no-repeat;\n"
"background-position: left center;\n"
"border: none;\n"
"border-left: 23px solid transparent;\n"
...
"border-radius: 15px;\n"
"background-color: qradialgradient(cx:0, cy:0, radius:1, fx:0.1, fy:0.1, stop:0 rgb(123 104 238),  stop:1 rgb(0, 205, 102));\n"
"border: 1px outset rgb(0, 205, 102);\n"
"}\n"
"")
...
"color: rgb(255, 255, 255);\n"
"border-radius: 15px;\n"
"background-color: qradialgradient(cx:0, cy:0, radius:1, fx:0.1, fy:0.1, stop:0 rgb(0,205,102),  stop:1 rgb(123,104,238));\n"
...
"}")
        ...
        self.ToggleBotton_6.setObjectName(u"ToggleBotton_6")#设置button name
        ...
        self.ToggleBotton_6.setMinimumSize(QSize(0, 60))
...
"}")
        ...
        #在 区域Model_QF_2中添加一个 model_box 控件
...
"QComboBox QScrollBar::handle:vertical {\n"
        ...
        #配置一个控件
        self.sys_setting_button = QPushButton(self.Model_QF_2)
        self.sys_setting_button.setObjectName(u"sys_setting_button")
        self.sys_setting_button.setMinimumSize(QSize(0, 0))
        self.sys_setting_button.setCursor(QCursor(Qt.PointingHandCursor))
        self.sys_setting_button.setStyleSheet(u"QPushButton{\n"
"background-image: url(:/all/img/file.png);\n"
"background-repeat: no-repeat;\n"
"background-position: left center;\n"
"border: none;\n"
...
"background-color: rgba(114, 129, 214, 59);\n"
"}")
        self.verticalLayout_21.addWidget(self.sys_setting_button)
...
"background-color: qlineargradient(x1:0, y1:0, x2:1, y2:1, stop:0 rgb(30,144,255), stop:1 rgb(0,205,102));\n"
"border-radius: 5px;\n"
"}")
...
"\n"
"QSlider::sub-page:horizontal {\n"
"background-color: qradialgradient(cx:0, cy:0, radius:1, fx:0.1, fy:0.1, stop:0 rgb(105, 105, 105),  stop:1 rgb(248, 194, 152));\n"
"border-radius: 5px;\n"
"}")
...
"	background-color: qlineargradient(x0:0, y0:1, x1:1, y1:1,stop:0.4  rgb(255,250,205), stop:1 rgb(255, 255, 255));\n"
"border:0px solid red;\n"
"border-radius:30px\n"
"}")
        ...
        self.show_labels_checkbox.setObjectName(u"show_labels")
...
"color: rgba(0, 0, 0, 140);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.VersionLabel.setText(QCoreApplication.translate("MainWindow", u"版本: 0.3", None))
        self.explain_title.setText(QCoreApplication.translate("MainWindow", u"MOT", None))
        ...
        self.sys_setting_button.setText(QCoreApplication.translate("MainWindow", u"外部模型导入", None))
