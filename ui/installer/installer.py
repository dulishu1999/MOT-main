...
def main():
    ...
    try:
        subprocess.check_call(f"{os.path.join('ui','installables', 'change_execution_policy.bat')}")
    except subprocess.SubprocessError:
        try:
            subprocess.check_call(f"{os.path.join('ui','installables', 'change_execution_policy_backup.bat')}")
